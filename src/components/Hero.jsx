      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#915EFF]'>Altaf Shaik</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-[#f3f3f3]`}>
            I'm Full stack web developer<br className='sm:block hidden' />
            Crafting Modern Web Experiences
          </p>
        </div>
      </div>
      <ComputersCanvas />
      <div className='absolute sm:bottom-10 bottom-30 w-full flex justify-center items-center'>
        <a href='#about'>
